"""
# RiotLib
Houses functions for retrieving information from the Riot API using requests.
This library is intended to work with API's from Riot as of 12/23/2024

## Data Dragon
This library also houses functions for accessing details from Riot Data Dragon API
"""
...
import requests
import json
# keep track of api versioning here, save headache updating code later.
# current api info can always be found at: https://developer.riotgames.com/apis
# -Kyle
